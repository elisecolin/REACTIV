...
<body bgcolor="#FFFFFF" background="/icones/iddn/iddn-fond.jpg">
        ...
        <table border=0 cellspacing=0 cellpadding=0 width= 100% BGCOLOR=#DCEFEE align="center">
          <tr HEIGHT="12"> 
            ...
            <td bgcolor="#229999" align=right valign="middle" height="12"> 
                ...
                <input type="hidden" name="NumeroIDDNOeuvre" value="IDDN.CH.010.0001617.000.R.P.1999.027.41100">
              ...
              <TABLE BORDER=0 cellspacing=0 cellpadding=0>
                ...
                <TR> 
                  <td><font face="Verdana, Arial, Helvetica, sans-serif"><b>
                    IDDN.CH.010.0001617.000.R.P.1999.027.41100
                    </b> 
                    </font>
                  </td>
                </tr>
                ...
                <TR> 
                  <TD BGCOLOR=white colspan=2><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">
                    la reproduction et la représentation dans le cadre du système IDDN,<br>
the reproduction and the performance within the scope of the IDDN system,<br>
die Wiedergabe und die Abbildung im Rahmen des IDDN Systems,<br>
la reproducción y la representación en el marco del sistema IDDN.
...
<td valign="bottom"><img src="/icones/1pix.gif" width="199" height="1" align="bottom">
                  <BR> <font face="Verdana, Arial, Helvetica, sans-serif" size="-2">
                    ...
                    <font face="Verdana, Arial, Helvetica, sans-serif" size="-2"> 
                     d378cb76187c5f86d1aa5431d840c59a
                    </font> 
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <TD colspan=2 ><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"> 
                     Pour toute autre utilisation contactez <A HREF="mailto:iddn@iddn.org" color="#000000"> InterDeposit Digital Number
                     </A>.<BR>
...
<!--<INPUT TYPE="button" NAME="oui" VALUE="Yes" ONCLICK="window.location.href='http://www.iddn.org/fr/logos.htm'">-->
                    <a href="http://www.iddn.org/fr/logos.htm"><img src="/icones/iddn/certificat/oui.gif" border="0"></a> 
                  </TD>
